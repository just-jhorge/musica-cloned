...
const Card = ({ title, artiste, trackImg, handleClick, index }) => {
	return (
		<div className="collection-container duration-1000 rounded-2xl h-[234px] w-full sm:w-[213px] text-white overflow-hidden flex items-end relative">
			<img
				src={trackImg}
				className="h-[234px] w-full lg:w-[213px] absolute top-0 left-0 transition-transform"
			/>
			<div className="flex w-full h-full px-5 py-6 items-end justify-between z-10 color-gradient">
				<div className="w-3/4 ">
					...
					<p className="likes lg:-mb-12 transition-all duration-1000 text-[10px] mt-6">
						2.3m likes
					</p>
				</div>
				<svg
					...
					width="40"
					height="40"
					className="play-icon h-10 w-10 lg:opacity-0 transition-all duration-700"
					viewBox="0 0 40 40"
					fill="none"
